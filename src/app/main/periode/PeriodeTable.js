        ...
        openDialog({
          children: (
            <>
              ...
              <DialogContent>
                <DialogContentText id="alert-dialog-description">Periode ini akan diaktifan ?</DialogContentText>
              </DialogContent>
              <DialogActions>
          ...
          {rows.length > 0 ? (
            rows.map((periode, idx) => (
              <TableRow key={periode.id}>
                ...
                <TableCell>{periode.tglMulai ? moment(periode.tglMulai).format('D MMMM YYYY') : '-'}</TableCell>
                <TableCell>{periode.tglBerakhir ? moment(periode.tglBerakhir).format('D MMMM YYYY') : '-'}</TableCell>
                <TableCell>
                  <Checkbox
